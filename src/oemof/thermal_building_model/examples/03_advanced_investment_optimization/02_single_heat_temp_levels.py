...
hot_water_tank_bus_from_storage = hot_water_tank_dataclass.get_bus_from_storage()
hot_water_tank_bus_into_storage = hot_water_tank_dataclass.get_bus_into_storage()
...
generate_error = True
connect_buses(
    input=hot_water_tank_bus_from_storage,
              target=heat_carrier_bus,
              #output=hot_water_tank_bus_into_storage
    )
if generate_error:
...
es.add(*(electricity_components + heat_components))
